...
public class TopUserCommand extends Comando {
	...
	public TopUserCommand() {
		super("top", Arrays.asList("topuser"), "top <user>");
	}
	...
	public EmbedBuilder embeds(Score score, BeatmapSearch beatmap, String username, long userId, int[] ordem) {
		...
		StringBuffer scores = new StringBuffer()
				.append(OusuEmote.getEmoteAsMention("300") + ": " + score.get300() + "\n")
				.append(OusuEmote.getEmoteAsMention("100") + ": " + score.get100() + "\n")
				.append(OusuEmote.getEmoteAsMention("50") + ": " + score.get50() + "\n")
				.append(OusuEmote.getEmoteAsMention("miss") + ": " + score.getMiss() + "\n");
