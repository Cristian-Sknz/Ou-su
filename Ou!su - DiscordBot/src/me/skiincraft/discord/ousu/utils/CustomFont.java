...
public class CustomFont {
	...
	public enum CustomFonts {
		BebasKai("BebasKai-Regular.ttf"),ErasDemi("ERASDEMI.TTF"),InsanityBurger("Insanibu.ttf"), MyFont("DISCORDIA.ttf"),
		Lane_UP("LANEUP_.TTF"), Lane_Cane("LANECANE.TTF"), ArialRound("ARLRDBD.TTF");
