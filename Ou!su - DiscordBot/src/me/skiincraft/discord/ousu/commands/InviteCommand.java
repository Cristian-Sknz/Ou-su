...
public class InviteCommand extends Commands {
	...
	public EmbedBuilder embed(Guild guild) {
		...
		embed.setDescription("Posso fazer parte do seu servidor discord\n"
				+ "Basta [Clicar aqui](" + invitelink + ") para me convidar!\n\n"
						+ "Caso queira um suporte, ou me conhecer mais um pouco\n"
						+ "Entre no meu Servidor Discord - [Ou!su Bot](https://discord.gg/VtkYdBR)");
