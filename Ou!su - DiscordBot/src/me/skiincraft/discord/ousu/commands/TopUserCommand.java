...
public class TopUserCommand extends Commands {
	...
	public String[] helpMessage() {
		return new String[] {"Este comando possibilita mostar as melhores estatisticas de um jogador", "O maximo de estatisticas que serão mostradas são 5"};
	}
	...
	public static EmbedBuilder embed(UserScores osuUser) {
		...
		embed.setFooter("["+ beat.getID() + "] "+beat.getTitle()+ " por " + beat.getArtist() + " | Mapa criado por " + author);
